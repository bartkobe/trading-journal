...
export function tradeToCsvRow(trade: TradeWithCalculations): TradeCSVRow {
  ...
  const isOpen = trade.exitDate === null || trade.exitPrice === null;
  ...
  return {
    ...
    pnl: trade.calculations?.pnl ?? null,
    pnlPercent: trade.calculations?.pnlPercent ?? null,
    fees: trade.fees ?? 0,
    netPnl: trade.calculations?.netPnl ?? null,
    entryValue: trade.calculations?.entryValue ?? 0,
    exitValue: trade.calculations?.exitValue ?? null,
    actualRiskReward: trade.calculations?.actualRiskReward,
    holdingPeriodHours: trade.calculations?.holdingPeriod ?? null,
    ...
    holdingPeriodDays: trade.calculations?.holdingPeriodDays ?? null,
